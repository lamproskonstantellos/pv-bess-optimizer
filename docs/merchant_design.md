...
| pv / bess sheets | capacities, efficiencies, SOC bounds, cycles | n/a | as in the SC doc |
| timeseries | `pv_kwh`, `dam_price_eur_per_mwh` | n/a | `load_kwh` optional/ignored |
...
grid-charging expense, per the BESS-DAM bundling convention), and the
